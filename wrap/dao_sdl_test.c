...
{
  {  "SDLTEST_MAX_LOGMESSAGE_LENGTH", DAO_FLOAT, SDLTEST_MAX_LOGMESSAGE_LENGTH},
  { NULL, 0, 0 }
};
...
int DaoSDL_TEST_OnLoad( DaoVmSpace *vms, DaoNamespace *ns )
{
	...
	dao_type_SDLTest_CommonState = DaoNamespace_WrapType( ns, dao_SDLTest_CommonState_Core, DAO_CDATA, 0 );
